    ...
    public List<Integer> slidingWindowTemplateByHarryChaoyangHe(String s, String t) {
        ...
        while (end < s.length()) {
            ...
            while (counter == 0 /* counter condition. different question may have different condition */) {
                ...
                char tempc = s.charAt(begin);// ***be careful here: choose the char at begin pointer, NOT the end
                                             // pointer
...
// Firstly, here is my sliding solution this question. I will sum up the
// template below this code.
